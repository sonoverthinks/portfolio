...
I recently built a [stock finance app](https://stock-charts-ruddy.vercel.app/s/AAPL) using NextJS, TailwindCSS, Prisma, Supabase, Lucia, and the Alpha Vantage API. The goal of this project was to create a web application that allows users to visualize the fundamentals of publicly traded stocks through interactive charts, while also providing a personalized experience through authentication.
