...
const Title = ({ data, source }) => {
  ...
  return (
    <Link
      ...
      href={link}
    >
      <div className="flex flex-row items-center gap-1 w-full md:max-w-[80%] text-dark-mirage dark:text-white dark:hover:text-dark-blue group-hover:text-light-blue text-[17px] leading-[33px]">
        {data.title}
      </div>
